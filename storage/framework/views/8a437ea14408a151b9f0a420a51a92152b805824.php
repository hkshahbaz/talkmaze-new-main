...
<head>
    ...
    <!-- Bootstrap CSS -->
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('dashboard/dist/css/pignose.calendar.min.css')); ?>" />
    ...
    <link rel="stylesheet" href="<?php echo e(asset('dashboard/css/steps.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(asset('dashboard/css/bootstrap-datetimepicker.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('dashboard/css/bootstrap-multiselect.min.css')); ?>">
    <link href="https://use.fontawesome.com/releases/v5.0.6/css/all.css" rel="stylesheet">
    <link href="https://cdn.jsdelivr.net/npm/select2@4.1.0-rc.0/dist/css/select2.min.css" rel="stylesheet" />
    <!--<link href="<?php echo e(asset('dashboard/css/fm.selectator.jquery.css')); ?>" rel="stylesheet">-->
...
<body>
  ...
  <!-- Modal -->
                          ...
                          <div class="col-md-12">
                              <div class=" form-register" action="#" method="post">
                                  <div id="form-total">
                                      ...
                                      <section>
                                          ...
                                          <input value="<?php echo e(csrf_token()); ?>" hidden type="text" id="csrf">
                              ...
                              <div id="lastmodal" style="display: none;">
                                  <div class="text-center">
                                      <img class="mt-1" src="<?php echo e(asset('images/tick mark.png')); ?>">
                                  </div>
            ...
            $.ajax({
                ...
                success:function (response) {
                    ...
                    response.forEach(obj=>{
                        if(obj.verb === "SESSION"){
                            data += '<a class="p-0 m-0" href="<?php echo e(url('/dashboard-coaching')); ?>">' +
                                '                                                <div class="row mt-1" >' +
                                '                                                    <div class="col-3">' +
                        ...
                        if(obj.verb === "CHAT"){
                            data += '<a class="p-0 m-0" href="<?php echo e(url('/chat/')); ?>/'+obj.actor_id+'">' +
                                '                                                <div class="row mt-1" >' +
                                '                                                    <div class="col-3">' +
                                '                                                        <img class="mt-3" src="'+obj.sender.profile.image+'" width="50">' +
                                '                                                    </div>' +
                        ...
                        if(obj.verb === "COMMENT"){
                            data += '<a class="p-0 m-0" href="<?php echo e(url('/forum-detail/')); ?>/'+obj.action_id+'">' +
                                '                                                <div class="row mt-1" >' +
                                '                                                    <div class="col-3">' +
                                '                                                        <img class="mt-3" src="'+obj.sender.profile.image+'" width="50">' +
                                '                                                    </div>' +
    ...
    <script src="<?php echo e(asset('dashboard/js/bootstrap-multiselect.min.js')); ?>"></script>
...
<?php /**PATH /home/vagrant/code/laravel/resources/views/user/dashboard/layouts/main.blade.php ENDPATH**/ ?>