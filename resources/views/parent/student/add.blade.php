                    ...
                    <div class="container-fluid">
                       ...
                       <div class="row">
                            <div class="col-md-12 mt-3">
                                <h2 class="text-muted">Add Student</h2>
                            </div>
                                                    ...
                                                    <div class="row justify-content-center mt-4 ">
                                                        <div class="col-md-12">
                                                            <div class="form-goup">
                                                                ...
                                                                <input type="text" id="student_name" class="form-control" name="student_name" value="{{ old('student_name') }}" placeholder="Student Name">
                                                        ...
                                                        <div class="col-md-12 mt-2">
                                                            <div class="form-goup">
                                                                ...
                                                                <input type="text" class="form-control datepicker" id="student_dob" name="student_dob" value="{{ old('student_dob') }}" placeholder="Student DOB">
