                        ...
                        @if(!is_null(auth()->user()->package))
                            <div class="row">
                                <div class="container">
                                    <div class="row">
                                        <div class="col-md-3 mt-2">
                                            ...
                                            <div class="card shadow-card">
                                                <div class="card-body">
                                                    <h1 class="text-center color-1">{{ auth()->user()->studentSessions->count() }}</h1>
                                    ...
                                    @if(!is_null(auth()->user()->package->plan))
                                        <div class="row">
                                            <div class="col-md-12 text-center mt-5">
                                                <h3 class="pb-0 dashboard-pkg-heading">
                                                    You have purchased "{{ auth()->user()->package->plan->name ?? '' }}" Package
                                                </h3>
                                                <p class="pakcage-paragraph">
                                                    You have <strong>{{ auth()->user()->package->remaining_hour ?? '' }} hours</strong> left in your current package
                                                </p>
                                            </div>
                                        </div>
                                    @endif
