...
<head>
    ...
    <link href="{{ asset('css/byajmal.css') }}" rel="stylesheet">
    <link href="{{ asset('animation/aos.css') }}" rel="stylesheet">
    <link rel="stylesheet" type="text/css" href="{{ asset('dashboard') }}/css/bootstrap-datetimepicker.min.css">
