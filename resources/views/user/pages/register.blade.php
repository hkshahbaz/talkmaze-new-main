                                    ...
                                    <form method="POST" action="{{ route('guest.register') }}" class="js-form form">
                                        ...
                                        <div class="row mt-0 pt-0">
                                            <div class="form-check  ml-3 mb-3">
                                                ...
                                                {!! $errors->first('subscriber', '<label id="subscriber-error" class="text-danger" for="subscriber">:message</label>') !!}
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-12 parent-block">
                                                <div class="row" id="parent_row-1">
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <input class="form-control bg-light" type="text" name="student_name[]"  style="height: 2.2rem;" data-validate-field="email" value="{{old('email')}}" required>
                                                        {!! $errors->first('email', '<label id="email-error" class="text-danger" for="email">:message</label>') !!}
                                                    </div>
                                                    <div class="col-md-12">
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content p-3" style=" margin-left: auto; margin-right:auto; display: block;">
                ...
                <div class="modal-body">
                    <iframe src="{{ url('/terms_conditions') }}" style="width:100%; height:70vh;">
