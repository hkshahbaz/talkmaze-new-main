      ...
      <div class="row" style="margin-right: 0px!important;">
        <div class="col-lg-5 col-md-5 text-justify m-auto">
          <div class="text-center text-justify">
            <h2 class="text-uppercase">{{$competition->title}} </h2>
           <a href="#compt"><button type="button" class="btn btn-dark text-uppercase mt-4">Read More</button></a>

          </div>
        </div>
        <div class="col-lg-7 col-md-7 m-auto">
          <div class="hub-img2">
            <img class="img-fluid mt-4 mb-4"  src="{{ $competition->comp_image  }}" width="300">
          </div>
        </div>
      </div>
    </div>
  </section>
  <section class="about-us-sec mt-4"  id="compt">
    <div class="container">
      <div class="row">
        <div class="col-md-7">
          <h4 class="text-dark text-uppercase pb-2">{{$competition->title}}</h4>
          <div class="inner2">&nbsp;</div>
            <p class="text-justify text-dark about-us-txt mt-3">{{$competition->description}}</p>
        </div>
        <div class="col-md-4 offset-md-1">
          <p class="text-center mt-3">
            <img src="{{$competition->comp_image}}" width="80%" style="border-radius: 50%">
          </p>
        </div>
      </div>
      <div class="row mt-2">
        <div class="col-md-7">
            <p class="font-weight-bold text-dark about-us-text mt-2 text-justify">Who is Eligible?</p>
            <p class="text-justify text-dark about-us-txt mt-1">{{$competition->requirement}}</p>
            <h5 class="color-a">
                ...
                @if($competition->status == "current")
                 <a href="#" data-toggle="modal" data-target="#loginModal" title="Apply Now"><button type="button" class="btn btn-dark text-uppercase mt-2">Compete Now</button></a>
                @elseif($competition->status == "future")
                <h5>We will be accepting applications soon!</h5>
                @else
                <h5>We are not accepting applications now!</h5>
                @endif
        </div>
      </div>
    </div>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content p-3" style="width: 80%; margin-left: auto; margin-right:auto; display: block;">
        <div class="modal-header">
          <h4 class="modal-title ml-auto" id="exampleModalLongTitle">Apply for Competition!</h4>
        ...
        <h5 class="modal-title ml-auto">{{$competition->title}}</h5>
          <form method="POST" action="{{ route('guest.competition.register') }}" class="js-form-login form">
          @csrf
                <div class="row mt-3">
                      <div class="col-md-6">
                   ...
                   <div class="row mt-3">
                      <div class="col-md-12">
                        <label class="text-muted h8" >Partner's Name(Optional)</label>
                        <input class="form-control bg-light" type="text" name="ptname"  style="height: 2.2rem;" data-validate-field="ptname" value="{{old('ptname')}}">
                        {!! $errors->first('ptname', '<label id="ptname-error" class="text-danger" for="ptname">:message</label>') !!}
                      </div>
                  </div>
                   <div class="row mt-2">
                    <div class="col-md-12">
                ...
                <div class="row mt-2">
                    <div class="col-md-12">
                      <label class="text-muted h8" >Date of Birth</label>
                      <input class="form-control bg-light" type="date" name="dob"  style="height: 2.2rem;" value="{{old('dob')}}">
                  </div>
                </div>
                <div class="row mt-2">
                    <div class="col-md-6">
            ...
            <button id="btn-default-login" type="submit" class="btn btn-default-login mt-4">Submit</button>
          </form>
        </div>
      </div>
    </div>
