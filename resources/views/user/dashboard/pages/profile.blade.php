                                            ...
                                            <div class="row justify-content-center ">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input name="email" type="text" class="form-control input-bg"
                                                ...
                                                <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input name="password" type="password" class="form-control input-bg"
                                            ...
                                            <div class="row justify-content-center">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input name="nick" type="text" class="form-control input-bg"
                                                               id="formGroupExampleInput3" placeholder=""
                                                               value="{{$user->nick}}">
                                                    </div>
