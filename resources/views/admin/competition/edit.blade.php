                                ...
                                <div class="col">
                                    <div class="card">
                                        <div class="card-header header-elements-inline">
                                            <h6 class="card-title">{{(isset($competition)) ? 'Update' : 'Add'}} Faq </h6>
                                         ...
                                         <div class="card-body">
                                            @if(isset($competition))
                                                {{ Form::model($competition,['method'=>'put','route' => ['competitions.update',$competition->id]]) }}
                                            @else
                                                {{ Form::open(['route' => 'competitions.index']) }}
                                            @endif
                                            <div class="row">
                                                <div class="col">
