                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col">
                                                    <div class="form-group">
                                                        ...
                                                        {{ Form::text('hours',old('hours'),array('class'=>'form-control hours', 'style'=> 'margin-bottom:10px;','placeholder'=>'Enter Hours')) }}
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    <div class="form-group">
                                                        ...
                                                        {{ Form::text('per_hour_amount',old('per_hour_amount'),array('class'=>'form-control per_hour_amount', 'style'=> 'margin-bottom:10px;','placeholder'=>'Per Hour Amount')) }}
                                                ...
                                                <div class="col">
                                                    <div class="form-group">
                                                        ...
                                                        {{ Form::text('total_amount',old('total_amount'),array('class'=>'form-control total_amount', 'style'=> 'margin-bottom:10px;','placeholder'=>'Total Amount')) }}
...
@push('after-scripts')
    <script>
        $(document).on("keyup", ".per_hour_amount, .hours", function(e){
            e.preventDefault();
            console.log("Ok");
            var event = $(this)
            calculate_total_amount(event);
        });

        function calculate_total_amount(event)
        {
            var per_hour_amount = parseFloat($.(".per_hour_amount").val());
            ...
            var total_amount = hours * per_hour_amount;
