                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    <div class="form-group">
                                                        ...
                                                        {{ Form::select('role', ['coach' => 'Tutor', 'user' => 'User' , 'admin' => 'Admin'] ,'T' , ['class' => 'form-control select2', 'style'=> 'margin-bottom:10px;']) }}
                                                ...
                                                <div class="col">
                                                    <div class="form-group">
                                                        ...
                                                        {{ Form::select('type', ['1' => 'Bronze', '2' => 'Silver' , '3' => 'Gold'] ,'T' , ['class' => 'form-control select2', 'style'=> 'margin-bottom:10px;']) }}
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    <div class="form-group">
                                                        ...
                                                        {{ Form::textarea('bio',old('bio'), array('class'=>'form-control', 'style'=> 'margin-bottom:10px;','placeholder'=>'Enter User Bio')) }}
