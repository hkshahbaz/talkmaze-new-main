                                    ...
                                    <div class="col">
                                        <div class="card">
                                            <div class="card-header header-elements-inline">
                                                ...
                                                <h6 class="card-title">{{(isset($course_content)) ? 'Update' : 'Enroll'}} Users </h6>
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            {{ Form::label('user_id','Select Users') }}<span style="color:red;">*</span>
                                                ...
                                                <div class="d-flex justify-content-end align-items-center">
                                                    <button type="submit" class="btn bg-blue ml-3">{{(isset($course_content)) ? 'Update' : 'Save'}} </button>
                                                </div>
