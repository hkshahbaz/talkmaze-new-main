...
@section('title', 'Competition Users')
                ...
                <div class="row">
                    <div class="col-xl-12">
                        ...
                        <!-- <div class="row">
                            <div class="col-lg-12">
                                <div>
                                    <a class="btn btn-dark w-25" href="{{ route('competitions.create') }}">Add New Competition</a>
                                </div>
                            </div>
                        </div> -->
                        <br>
                                ...
                                <div>
                                    <div class="card">
                                        <div class="card-header header-elements-inline">
                                            <h5 class="card-title">Competition Users List</h5>
                                        ...
                                        <script>
                                            $(function() {
                                                $('#rtable').DataTable({
                                                    ...
                                                    autoWidth: false,
                                                    responsive: true,
                                                    ajax: '{!! route('competitionusers.index') !!}',
                                                    columns: [
                                                        { data: 'id', name: 'id' },
