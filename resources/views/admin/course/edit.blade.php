                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col">
                                                    <div class="form-group">
                                                        {{ Form::label('user_id','Select Course Owner') }}<span style="color:red;">*</span>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col">
                                                    <div class="form-group">
                                                        {{ Form::label('is_private','Course Type') }}<span style="color:red;">*</span>
                                                        {{ Form::select('is_private', ['Public'=>0, 'Private'=>1] ,old('is_private'), ['class' => 'form-control select2', 'style'=> 'margin-bottom:20px;']) }}
    
                                                        {!! $errors->first('is_private', '<label id="is_private-error" class="error" for="is_private">:message</label>') !!}
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
