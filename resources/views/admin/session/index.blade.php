                                        ...
                                        <script>
                                            $(function() {
                                                $('#rtable').DataTable({
                                                    ...
                                                    columns: [
                                                        { data: 'id', name: 'id' },
                                                        { data: 'zoom_id', name: 'Zoom ID' },
                                                        { data: 'session_id', name: 'Session ID' },
                                                        { data: 'tutor', name: 'Tutor' },
                                                        { data: 'student', name: 'Student' },
                                                        { data: 'timeTaken', name: 'Time' },
                                                        { data: 'sessionStatus', name: 'Status' },
                                                        { data: 'refundStatus', name: 'Refund Request' },
                                            ...
                                            $(document).on("click", ".refund_btn", function(){
                                                ...
                                                $.get("{{route('session.load.refund.form')}}", {student_id: student_id}, function(result){
